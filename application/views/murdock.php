<!doctype html>
  ...
  <!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="en"> <![endif]-->
      ...
      <!--[if IE 8]>         <html class="no-js lt-ie9" lang="en"> <![endif]-->
        ...
        <?php if($mobile) { ?>
          ...
          <div align="center" style="margin-bottom:10px;margin-top:10px;">
            ...
            <li><a href="<?php echo base_url('page_distributor');?>">stockist</a></li>
    ...
    <section class="intro full-width jIntro" id="anchor00">
      ...
      <div class="playerVideo" data-property="{videoURL:'https://youtu.be/StWXFIV3N8E',showControls:false,containment:'self',autoPlay:true, mute:true, startAt:0,opacity:.7,ratio:'4/3', addRaster:true, realfullscreen: true}"> <!-- Slider -->
  ...
  <footer>
    ...
    <div class="container-fluid">
      ...
      <div class="copyright">
        ...
        <p>&copy; <?php echo date('Y');?> Kemas Kosmetik. all rights reserved. Website design by <a href="http://myhassee.com" target="_blank">MyHassee.com</a>.</p>
    ...
    <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCiIMMCMPwPnZPz-6J2139qSwTo6IAHeR4"></script>
      ...
      <script type="text/javascript">
        ...
        (function(){
          ...
          s1.src='https://embed.tawk.to/600a53bda9a34e36b96f113c/1esk5e7q2';
