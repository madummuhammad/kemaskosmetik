	...
	<div class="ps-container">
		...
		<div class="ps-page__container" style="display: inherit !important;">
			<div class="ps-product--detail ps-product--fullwidth">
				<!-- <div class="alert alert-danger" role="alert"><b>INFO: Untuk sementara kami tidak melayani pembelian online karena adanya pemberlakuan PPKM darurat. Terima kasih atas perhatiannya.</b></div><br> -->
						...
						<div class="ps-product__shopping">
							...
							<figure>
								<div class="form-group--number">
									...
									<input type="text" name="quantity" class="form-control input-number" data-min="<?=(int)$minimum?>" data-max="50" value="<?=(int)$minimum?>" placeholder="<?=(int)$minimum?>">
								</div>
							</figure>
